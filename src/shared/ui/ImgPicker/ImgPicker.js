      ...
      <div className='input-container-main-data-added'>
        ...
        >
          ...
          >
            ...
            >
              <div
                className={`${styles.close_scss} z-10 bg-red-600 text-white cursor-pointer pointer-events-auto w-3 h-3 transform -translate-y-1/2 -translate-x-1/2 rtl:translate-x-1/2 rounded-sm absolute grid place-content-center text-xs shadow-md`}
                onClick={removeImg}
              >
                <span>x</span>
              </div>
